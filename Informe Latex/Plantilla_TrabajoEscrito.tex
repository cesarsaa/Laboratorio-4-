...
~\\ Antes de plantear la hipotesis es necesario realizaar un cambio de unidades, puesto que la informacion de la muestra se encuenta en libras y los analisis respectivos que se requieren se van a llevar a cabo en KG. Para lo cual se realiza una regla de tres para encontrar las equivalencias.
