...
~\\Acorde a los resultados obtenidos por la secretaría de educación y consignados en la tabla, se procede a plantear la hipotesis con la cual se pueda decidir si es acertado ubicar la escuela en la comuna A. 
...
~\\  La region de rechazo asignando una confianza del 95\% sera RC = {$\left \{ Z_{p} < Z_{\alpha} \right \} \to  0.1444  < 1.645$}
...
\pagebreak
~\\ \textbf{Conclusion:}
~\\ Con base en los resultados obtenidos en los cuales nuestro valor $Z_{p} = 0.1444$ se encuentra en la region de aceptación, pese a ser un margen de aceptación bastante bajo es adecuada la decisión de la secretaria de educación de ubicar la escuela en la comuna A, es decir aceptamos la hipotesis nula y por lo tanto con una significancia de $5\%$ podemos afirmar que pese a que la diferencia de proporciones de la población es pequeña podemos aceptar la construcción del centro educativo. 

\subsection{Situaci\'{o}n 6}
\subsection{Punto C.}
~\\ De acuerdo con la informacion proporcionada procedemos a realizar el planteamiento de la hipotesis, hipotesis con la cual podremos decidir si el peso medio de los niños es inferior a los 3.0KG. 

~\\ Antes de plantear la hipotesis es necesario realizar un cambio de unidades, puesto que la información de la muestra se encuentra en libras y los análisis respectivos que se requieren se van a llevar a cabo en KG. Para lo cual se realiza una regla de tres para encontrar las equivalencias.

~\\ Tras realizar los cálculos pertinentes, se obtuvo que 3 Kilogramos equivalen a 6 Libras de peso, ahora se procede a plantear la hipotesis.
...
~\\   La region de rechazo asignando una confianza del 95\% sera RC = {$\left. Z_{p} < Z_{\alpha} \right \} \to  -2.054 < -1.645$}
...
\pagebreak
~\\ \textbf{Conclusion:}
~\\ Al realizar la prueba de hipotesis y contrastar los resultados se puede observar como con nivel de significancia del $5\%$ es posible rechazar la hipotesis nula $H_{o}$ implicando esto que al nacer lo niños de la población de estudio cuentan con un peso medio inferior a las 6 Libras o los correspondientes 3KG, los que nos lleva la aceptación de la hipotesis alterna 
...
\subsection{Punto A.}
~\\ De acuerdo con la información de desempleo consignada en la tabla anterior, se puede proceder a plantear la hipotesis para verificar si el programa piloto lanzado por El Ministerio de Protección Social tuvo los resultados esperados. 
...
~\\ La region de rechazo para el nivel de significancia asignado sera $\left. Z_{p} < Z_{\alpha} \right \} \to  -1.378 < 1.77.$
...
\pagebreak
~\\ \textbf{Conclusion:}
~\\ Tras realizar la prueba de hipotesis se puede observar como el valor $ Z_{p}$ es mucho meno al  $Z_{\alpha}$ y es posible contar con la suficiente evidencia para aceptar la hipotesis nula y por lo tanto concluir con una de significancia del 5\% que el nivel de desempleo afronta una disminución superior al 2\% por lo cual El Ministerio de Protección Social puede dar como exitoso el programa tras tres meses de pruebas. 
...
~\\ El estadistico de prueba para esta dado por: $\frac{D^2}{nS^2}$ donde D es la suma de las diferencias corregidas.
...
\pagebreak
~\\ \textbf{Conclusion:}
~\\ Dado que el valor P es mucho mayor al nivel de significancia $0.3685>0.05$ no podemos rechazar que la distribución sea normal, dicha conclusión es mucho mas visible si la apreciamos gráficamente como se muestra en la grafica 
